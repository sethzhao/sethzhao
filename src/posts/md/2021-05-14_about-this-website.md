...
# 用了什么技术栈
个人项目当然是要尝尝鲜，所以用了 Vue3 ，并且用实验性语法 script-setup ，感觉有了这个才能和 React 那边的 Hooks 比比，但是还是有几点想吐槽的。
...
```
按照约定定义的文件名本身就携带发布日期和 URL 信息，省去了繁琐的配置。文章列表页面读取这个 JSON ，拆分 md 文件名，就能展示出文章列表。文章内容就由插件将 Markdown 内容转义成 HTML 来展示。  
